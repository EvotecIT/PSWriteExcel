...
@{
    ...
    RequiredModules      = @(@{ModuleName = 'PSSharedGoods'; GUID = 'ee272aa8-baaa-4edf-9f45-b6d6f7d844fe'; ModuleVersion = '0.0.163'; })
    ...
    'Excel', 'WorkbookProperties', 'Find-ExcelDocumentText', 
    'Get-ExcelDocument', 'Get-ExcelProperties', 
